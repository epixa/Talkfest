...
/**
 * A hasher and comparer implementation of PHPass
 *
 ...
 */
class PHPass implements Hasher, Comparer
{
    protected $_itoa64;
    ...
    /**
     * Checks whether the password, when hashed, matches the given hash
     *
     * The password is hashed in the same fashion that the given hash is hashed in.
     *
     * @param string $hash
     * @param string $password
     * @return bool
     */
    public function compare($hash, $password)
    {
